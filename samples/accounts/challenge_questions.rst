...
to answer the challenge questions if the site does not recognize your browser 
because your cookie expired or was deleted. As such, people need to answer their 
challenge questions with much more frequency. Generally the site will save your 
answers to 4 or 5 challenge questions, and will present you with 1 or 2 that you 
must answer correctly before you will be allowed to login. To accommodate these 
needs, Avendesora saves the challenge questions and either stores or generates 
the answers. It also has the ability to type the answers directly into the 
website.
...
In this case 5 questions are supported. When are first required to set up your 
challenge questions they generally present you with 20 or 30 to choose form.  
Simply choose the first few and add them to your account. Then use the value 
command to generate the answers and copy them into the website. Finally, the 
...
simply specify the array and Avendesora will request you to choose a particular 
...
terminate the script with '{return}' rather than '{tab}', it will take you to th 
next page.

In some cases the website makes you choose from a fixed set of answers. In this 
case you would save both the answer with the question, as follows:
